...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language To Text Conversion- IncludeEd")
        ...
        self.T.config(text="Sign Language To Text Conversion- IncludeEd", font=("Courier", 30, "bold"))
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread(image_path)                # img_final=img_final1=img_final2=0
